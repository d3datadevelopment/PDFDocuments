...
## [Unreleased](https://git.d3data.de/D3Public/pdfdokumente/compare/1.1.0.3...rel_1.x)

## [1.1.0.3](https://git.d3data.de/D3Public/pdfdokumente/compare/1.1.0.2...1.1.0.3) - 2025-11-11
### added
- Support für PHP 7.4
