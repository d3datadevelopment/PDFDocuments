...
## [Unreleased](https://git.d3data.de/D3Public/pdfdokumente/compare/2.2.0.0...rel_2.x)

## [2.2.0.0](https://git.d3data.de/D3Public/pdfdokumente/compare/2.1.1.0...2.2.0.0) - 2026-06-25
### Added
- make installable in OXID 7.5
- creator not is extendable
- keywords and subject can defined
### Fixed
- translation items
### Changed
- improved error and notice message encoding
- Images are embedded inline (where possible), making it possible to omit BasicAuth credentials
### Removed
