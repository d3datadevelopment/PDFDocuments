[{block name="pdfPastThankFile"}]
    ...
    [{if $order->getFieldData('d3pdftextbestellbestaetigung')}]
        <tr><td class="past_thank_width100 fontSize12">[{$order->getFieldData('d3pdftextbestellbestaetigung')|nl2br}]</td></tr>
    [{/if}]
        <tr><td class="past_thank_width100 paddingTop10 fontSize12">[{$payment->getFieldData('d3shortdescpdf')|nl2br}]</td></tr>
        [{**Schlusstext/ Abschied***}]
        <tr><td class="past_thank_width100 paddingTop10 fontSize12">[{oxmultilang ident="ORDER_OVERVIEW_PDF_GREETINGS_AUFTRAG_1"}]</td></tr>
